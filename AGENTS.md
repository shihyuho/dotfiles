...
- For dotfiles/config changes, run `zsh -n ~/.zshrc` and `make test`.
- If startup behavior changes or regresses, also run `make measure-startup`; keep interactive shell startup under `0.5s`.
